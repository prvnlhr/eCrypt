    ...
    >
      <div className={styles.buttonContainer}>
        {maximize === true && editId === doc._id ? (
          <div className={styles.minimizeBtn} onClick={minimizeImg}>
          </div>
        ) : (
          <div className={styles.minimizeBtn} onClick={maximizeImg}>
          </div>
        )}
        <div className={styles.imageDeleteDiv} onClick={handleDelete}>
          <CgTrashEmpty  />
        </div>
